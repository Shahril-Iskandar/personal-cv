...
\section{Publications} 
  ...
  \resumeSubHeadingListStart
    ...
    \item
        ...
        \def\labelprefix{J}
        \begin{etaremune}
            \item\label{article: diffusion_openpose}{Zhou, T$^\dagger$, \textbf{Iskandar, M. N. S.}$^\dagger$, \& Chiam, K. H.* (Accepted, 2025). Diffusion Models Enable Zero-Shot Pose Estimation for Lower-Limb Prosthetic Users. \textit{PLOS Digital Health}. \href{https://arxiv.org/abs/2312.07854}{\faFilePdfO}}
