...
\section{Publications} 
  ...
  \resumeSubHeadingListStart
    ...
    \item
        ...
        % \def\labelprefix{P}
        % \begin{etaremune}            
        %     % \item\label{article: fyp}{\textbf{Iskandar, M. N. S.}*, Tan, J. C. C., Wong, H., Low, A., \& Sahrom, S. B. (In preparation). Criterion Validity of The FLEX Device Measuring Barbell Velocity in Weightlifting Exercises Across the Load-Velocity Profile.}

        %     \item\label{article: spm exoskeleton}{Kong, P. W.*, \textbf{Iskandar, M. N. S.}, Koh, A. H., Ho, M. Y. M., \& Lim, C. X. E. (In preparation). Benefits of Exoskeleton During Loaded Walking In Military Personnel.}
        % \end{etaremune}
